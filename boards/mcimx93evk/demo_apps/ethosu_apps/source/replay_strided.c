#include "replay_templates_relu.h"
#include <stdio.h>
...
void replay_handle_interrupt(void)
{
    ...
    //print_memory((const void *)target_addr, 1472);
    LOG_INFO("\n");
}
...
uint32_t register_access(reg_op_record_t *record) {
    ...
    switch (record->op_order) {
        case 24:
            memcpy((void *)0x204801b0, op_24_data, sizeof(op_24_data));
            break;
        case 28:
        ...
        case 34:
            ...
            break;
        case 37:
            memcpy((void *)0x20485400, op_37_input_record_data, sizeof(op_37_input_record_data));
            break;
        case 40:
